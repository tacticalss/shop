...
print(Fore.BLUE+pyfiglet.figlet_format('    hackers85'))


banner = (Fore.CYAN+"""                        @hackers85""")
for bnr in banner:
...
print("")
print("")
Rubik = (Fore.BLACK+"                   0ur telegram channel: @hackers85")
for Ru in Rubik:
    sys.stdout.write(Ru)
    sys.stdout.flush()
    time.sleep(0.1)
print("")
Rubi = ("                 0ur telegram channel: @hackers85")
for ru in Rubi:
    sys.stdout.write(ru)
    sys.stdout.flush()
    time.sleep(0.1)
